...
const Rating = () => {
  return (
    <div className='flex gap-[20px] h-[80vh] w-full px-15 bg-zinc-800 py-20'>
      <div className='h-[52vh] w-[57vw] bg-[#004D43] rounded-[15px] flex flex-col relative justify-center items-center'>
        <div className='logo'>
        <svg width="109" height="65" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='absolute bottom-10 left-10'>
          <Button text="C 2019-2025" />
        </div>
      </div>
      <div className='h-[52vh] w-[27vw] bg-[#212121] flex flex-col justify-center items-center relative rounded-[15px]'>
        <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
        <div className='absolute bottom-10 left-10'>
          <Button text="rating 5.0 on clutch" />
        </div>
      </div>
      <div className='h-[52vh] w-[27vw] bg-[#212121] flex flex-col justify-center items-center relative rounded-[15px]'>
        <img className='h-[10vh] w-[10vh]' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
        <div className='absolute bottom-10 left-10'>
          <Button text="business bootcamp alumni" />
        </div>
      </div>
    </div>
  )
