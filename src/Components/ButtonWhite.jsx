...
const ButtonWhite = ({ text = "BUTTON", onClick, href, className = "" }) => {
  ...
  return (
    <Component
      href={href}
      onClick={onClick}
      className={`uppercase rounded-[34px] px-3 py-1 text-white border-1 border-white bg-black relative overflow-hidden group transition-all duration-300 ease-[cubic-bezier(0.23,1,0.320,1)] hover:scale-105 hover:text-black active:scale-100 ${className}`}
    >
